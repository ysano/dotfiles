...
**分割基準**:
- AI Agent が 3 ターン以内で実装完了できるサイズ（4-6 ターンは Spec 補足の兆候）
- 変更ファイル数: 5 ファイル以下が目安
- PR 差分: 300 行以下が目安
...
> **Context**: [ユーザーペルソナ] + [達成したい目標]
>
> **Current Behavior**: [現在のユーザー体験、制限事項]
>
> **Expected Behavior**: [ユーザーストーリー形式: 〜として、〜したい、〜のために]
>
> **Constraints**: [UI/UX 制約、既存フローとの互換性]
>
> **Verification**: [受け入れ基準、E2E テストシナリオ]
