...
Implement comprehensive monitoring and observability solutions for production systems.
...
- Train team on monitoring tools and incident response

See also: `performance` Skill `references/monitoring.md`
